 ...
 * Resolverlo siendo case sensitive y sin ser case sensitive. 
 */
public class Ejercicio12 {
	...
	public static void main(String[] args) {
		...
		String wordNoCaseSensitive = word.toLowerCase();
		...
		while(ini < fin) {
			...
			if (wordNoCaseSensitive .charAt(ini) != wordNoCaseSensitive .charAt(fin)) {
